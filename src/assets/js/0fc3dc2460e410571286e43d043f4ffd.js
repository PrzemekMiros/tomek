/**handles:swv,contact-form-7,jquery-core,wpb_composer_front_js,vc_jquery_skrollr_js,jquery-migrate**/
!(function () {
  "use strict";
  var n = {
      d: function (t, e) {
  ...
  n.r(a),
    ...
    (t.prototype.getAll = function (t) {
      ...
      const s = (t) => {
        const e = [];
        if (t instanceof Map) for (var [i, n] of t) e.push(...s(n));
        else "" !== t && e.push(t);
        return e;
      };
      return s(this.get(t));
  ...
  var r = t,
    e;
  function p({ rule: t, field: e, error: i, ...n }) {
  ...
  window.swv = {
    validators: a,
    validate: (t, e, i = {}) => {
      const n = (t.rules ?? []).filter(
        ({ rule: t, ...e }) =>
          "function" == typeof a[t] &&
          ("function" != typeof a[t].matches || a[t].matches(e, i))
      );
      if (!n.length) return new Map();
      const s = new r(e),
        o = n.reduce((e, t) => {
          const { rule: i, ...n } = t;
          if (e.get(n.field)?.error) return e;
          try {
            a[i].call({ rule: i, ...n }, s);
          } catch (t) {
            if (t instanceof p) return e.set(n.field, t);
          }
          return e;
        }, new Map());
      for (const t of s.keys())
        o.has(t) || o.set(t, { validInputs: s.getAll(t) });
      return o;
    },
